...
public class TroubleshootActivity extends AppCompatActivity implements SelectListner  {



    private static final String HI = "https://script.google.com/macros/s/AKfycbxLAA-MpznkRCsawPPPbzNMPm5MajB12xDs_cg4OptPD6SMlkJpxP5IkCRLKH4tlXnd/exec";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog = new ProgressDialog(TroubleshootActivity.this);
